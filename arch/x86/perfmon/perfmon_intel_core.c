...
#define PFM_CORE_D(n) \
	PMD_DR(PFM_REG_C, "PMC"#n, MSR_P6_PERFCTR0+n, PFM_CORE_CTR_RSVD)
#define PFM_CORE_FD(n) \
	PMD_DR(PFM_REG_C, "FIXED_CTR"#n, MSR_CORE_PERF_FIXED_CTR0+n, \
	       PFM_CORE_CTR_RSVD)
...
static void __kprobes pfm_core_quiesce(void)
{
	...
	if (test_bit(16, cast_ulp(pfm_pmu_conf->regs.pmcs)))
		wrmsrl(MSR_CORE_PERF_FIXED_CTR_CTRL, 0);
	if (test_bit(17, cast_ulp(pfm_pmu_conf->regs.pmcs)))
