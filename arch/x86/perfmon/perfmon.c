 ...
 *
 * called from pfm_pmu_acquire() with pfm_pmu_conf.regs copied
 * from pfm_pmu_conf.full_regs needs to adjust regs to match
 * current PMU availabilityy
 *
